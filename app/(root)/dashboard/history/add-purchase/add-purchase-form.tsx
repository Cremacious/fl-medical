  ...
  return (
    <div className="flex items-center justify-center">
      <div className="rounded-lg">
        <Form {...form}>
          <form className="">
            <div className="customBlue p-4 roundShadow flex flex-col md:flex-row gap-4 justify-evenly items-center">
              <FormField
                      ...
                      <PopoverTrigger asChild>
                        <FormControl>
                          <Button
                            variant={'outline'}
                            className={cn(
                              'bg-white pl-3 text-left font-normal w-[120px]',
            ...
            <div className="customBlue p-4 roundShadow my-4">
              <FormField
                control={form.control}
                name="name"
                render={({ field }) => (
